def alak():
    print('Note that this is a variant of alak consisting of a circular board')
    print('Meaning that the first square is now next to the last.', '\n')
    # variables
    user_input = False
